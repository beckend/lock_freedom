    ...
    loop {
      ...
      let res = unsafe {
        ...
        self
          ...
          .as_ref()
          .ptr
          .compare_exchange(loaded, node.as_ptr(), AcqRel, Relaxed)
      };
        ...
        Ok(_) => {
          ...
          let res = unsafe {
            ...
            prev
              .as_ref()
              .next
              .compare_exchange(null_mut(), node.as_ptr(), Release, Relaxed)
          };
    ...
    loop {
      ...
      let res = unsafe {
        ...
        self
          ...
          .as_ref()
          .ptr
          .compare_exchange(ptr, (ptr as usize | 1) as *mut _, Relaxed, Relaxed)
      };
